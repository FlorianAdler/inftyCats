\newcommand{\ho}{h} %homotopy category, \operatorname{ho}
...
\end{proof}
\begin{numpar}[Unit and counit.]\label{par:1Unit}
...
\begin{lem}\label{lem:1FullyFaithfulConservativeAdjunction}
	...
	\begin{alphanumerate}
		...
		\item Suppose $L$ is fully faithful and $R$ is conservative \embrace{that is, if $\alpha\colon x\rightarrow y$ is a morphism in $\Dd$ such that $R(\alpha)$ is an isomorphism, then $\alpha$ is an isomorphism too}. Then $L$ and $R$ are inverse equivalences of categories.\label{enum:1Conservative}
	\end{alphanumerate}
\end{lem}
\begin{proof}
...
\begin{lem}\label{lem:LiftingConditions}
	\begin{alphanumerate}
		...
		\begin{equation*}
			...
			\end{tikzcd}
		\end{equation*}
		has a unique solution. Furthermore, if $X$ is a simplicial set with this horn filling property, then $X\cong \N(\Cc)$ for some category $\Cc$ \embrace{which is necessarily the homotopy category $\ho(X)$}.
	\end{alphanumerate}
\end{lem}
...
\begin{numpar}[Some informal motivation.]\label{par:StraighteningMotivation}
	...
	\begin{center}
		\begin{tikzpicture}[xscale=\TikzScaleFactor,yscale=-\TikzScaleFactor,line cap=round, line join=round, line width=rule_thickness,decoration={markings,mark=at position 0.5 with {\arrow{to}}}]
			% F(x)
			\draw [dashed,fill=white!93!black,dash phase=2] (30.3,21.9) .. controls ++(0.6,-0.6) and ++(0.0,1.1) .. ++(1.2,-1.9) .. controls ++(0.0,-1.7) and ++(0.6,1.4) .. ++(-1.2,-3.8) .. controls ++(-1.0,-2.2) and ++(-1.7,0.0) .. ++(3.6,-3.8) .. controls ++(1.7,0.0) and ++(-1.3,-1.7) .. ++(3.6,3.3) .. controls ++(0.8,1.1) and ++(-0.2,-1.6) .. ++(2.4,1.9) .. controls ++(0.2,1.8) and ++(0.8,-1.3) .. ++(-1.2,4.3) .. controls ++(-0.6,0.9) and ++(0.0,-1.2) .. ++(-0.9,2.8) .. controls ++(0.0,1.1) and ++(-0.5,-0.8) .. ++(0.3,2.8) .. controls ++(0.5,0.7) and ++(0.0,-1.0) .. ++(0.6,2.4) .. controls ++(0.0,0.7) and ++(0.1,-0.6) .. ++(-0.6,1.4) .. controls ++(-0.4,1.6) and ++(1.1,0.0) .. ++(-2.4,1.9) .. controls ++(-1.7,0.0) and ++(1.2,1.9) .. ++(-4.3,-1.9) .. controls ++(-0.6,-0.9) and ++(0.8,0.5) .. ++(-1.2,-2.9) .. controls ++(-0.5,-0.3) and ++(0.0,0.8) .. ++(-0.6,-1.9) .. controls ++(0.0,-1.0) and ++(0.0,1.0) .. ++(0.6,-2.4) .. controls ++(0.0,-0.9) and ++(-0.5,0.4) .. ++(0.0,-2.4) -- cycle;
			
			% F(y)
			\draw [dashed,fill=white!93!black] (64.7,21.9) .. controls ++(0.4,-0.5) and ++(0.0,0.8) .. ++(0.6,-1.9) .. controls ++(0.0,-1.5) and ++(0.6,1.3) .. ++(-0.6,-3.8) .. controls ++(-1.2,-2.6) and ++(-2.0,0.0) .. ++(4.3,-4.8) .. controls ++(1.6,0.0) and ++(-1.2,-1.6) .. ++(3.6,2.8) .. controls ++(0.9,1.2) and ++(-0.2,-1.8) .. ++(2.7,1.9) .. controls ++(0.3,2.3) and ++(1.0,-1.6) .. ++(-0.9,5.7) .. controls ++(-0.5,0.8) and ++(0.0,-1.2) .. ++(-0.6,2.8) .. controls ++(0.0,1.1) and ++(0.0,-1.1) .. ++(0.3,2.8) .. controls ++(0.0,1.0) and ++(0.0,-1.0) .. ++(0.6,2.4) .. controls ++(0.0,1.0) and ++(0.2,-0.9) .. ++(-0.6,2.4) .. controls ++(-0.5,2.0) and ++(1.3,0.0) .. ++(-3.3,0.9) .. controls ++(-1.2,0.0) and ++(1.2,0.0) .. ++(-3.0,1.0) .. controls ++(-1.2,0.0) and ++(0.8,1.3) .. ++(-2.4,-2.8) .. controls ++(-0.5,-0.8) and ++(0.7,0.4) .. ++(-0.6,-2.9) .. controls ++(-0.6,-0.4) and ++(0.0,1.1) .. ++(-1.2,-1.9) .. controls ++(0.0,-1.0) and ++(0.0,1.0) .. ++(0.6,-2.4) .. controls ++(0.0,-1.0) and ++(-0.6,0.4) .. ++(0.6,-2.4) -- cycle ;
			draw  (35.8,21.0) .. controls ++(8.5,8.5) and ++(0.0,0.0) .. ++(31.1,8.2) ;
			
			% Cat_\infty
			\draw [dotted] (-17.0,35.7) .. controls ++(-1.8,-6.1) and ++(0.4,5.6) .. ++(5.6,-9.2) .. controls ++(-0.3,-5.3) and ++(-4.8,1.7) .. ++(14.0,-5.5) .. controls ++(3.3,-1.2) and ++(0.6,5.0) .. ++(6.2,-5.8) .. controls (8.4,10.8) and (16.8,10.0) .. (21.2,9.2) .. controls (28.2,7.9) and (35.3,8.3) .. (42.5,7.9) .. controls ++(4.5,-0.2) and ++(-4.5,-0.9) .. ++(13.1,-0.1) .. controls ++(5.8,1.2) and ++(-5.9,-0.3) .. ++(17.8,0.3) .. controls ++(4.8,0.2) and ++(-4.8,-0.2) .. ++(10.9,2.3) .. controls ++(3.2,0.1) and ++(3.9,-5.0) .. ++(8.7,4.1) .. controls ++(-2.8,3.6) and ++(-2.8,-1.1) .. ++(10.5,3.4) .. controls ++(5.1,1.9) and ++(-5.1,-2.9) .. ++(2.9,5.2) .. controls ++(3.5,2.0) and ++(-3.9,-1.1) .. ++(5.3,5.5) .. controls ++(3.6,1.0) and ++(1.4,-4.2) .. ++(6.3,7.2) ;
			
			\coordinate (u) at (35,19);
			\coordinate (v) at (69,19);
			\coordinate (w) at (69,29);
			\fill (u) circle (0.45ex/\TikzScaleFactor) node[shift=(120:0.3)] {$u$};
			\fill (v) circle (0.45ex/\TikzScaleFactor) node[shift=(30:0.3)] {$v$};
			\fill (w) circle (0.45ex/\TikzScaleFactor) node[shift=(-30:0.32)] {$w$};
			
			\draw[|-to] ($(u) + (20:1.1ex/\TikzScaleFactor)$)  to[out=20,in=165] node[pos=0.5,above] {$\scriptstyle F(\alpha)$} ($(v) + (165:1.1ex/\TikzScaleFactor)$);
			\draw[postaction={decorate}] ($(v) + (90:1.1ex/\TikzScaleFactor)$)  to ($(w) + (-90:1.1ex/\TikzScaleFactor)$);
				
			\node at (24,19) {$F(x)$};
			\node at (81,24) {$F(y)$};
			\node at (-2,28) {$\cat{Cat}_\infty$};
			
			\begin{scope}[yshift=-70cm]
				\coordinate (x) at (35,55);
				\coordinate (y) at (69,55);
				\fill (x) circle (0.45ex/\TikzScaleFactor) node[left=3] {$x$};
				\fill (y) circle (0.45ex/\TikzScaleFactor) node[right=3] {$\smash{y}\vphantom{x}$};
				\draw[postaction={decorate}] ($(x) + (20:1.1ex/\TikzScaleFactor)$)  to[out=20,in=165] node[pos=0.5,below] {$\scriptstyle\alpha$} ($(y) + (165:1.1ex/\TikzScaleFactor)$);
				\node at (20,55) {$\Cc$};
				
				%C
				\draw [dotted] (38.0,53.2) .. controls ++(5.8,2.7) and ++(-6.5,0.7) .. ++(15.6,1.6) .. controls ++(6.1,-0.5) and ++(-2.3,1.1) .. ++(12.1,-2.0) ;
				\draw [dotted] (39.0,53.6) .. controls ++(3.4,-1.1) and ++(-4.6,0.2) .. ++(9.1,-1.7) .. controls ++(11.6,-0.5) and ++(-2.2,-0.8) .. ++(16.3,1.4) ;
				\draw [dotted] (17.6,59.0) .. controls ++(4.5,2.5) and ++(-2.1,-2.6) .. ++(16.5,4.0) .. controls ++(2.9,3.7) and ++(-5.9,-0.4) .. ++(19.6,2.9) .. controls ++(10.0,0.6) and ++(-3.8,-0.5) .. ++(14.2,-0.9) .. controls ++(6.0,0.9) and ++(-4.7,2.2) .. ++(13.8,-5.5) .. controls ++(11.2,-5.4) and ++(11.9,1.8) .. ++(-6.9,-10.4) .. controls ++(-13.9,-2.1) and ++(11.8,-0.3) .. ++(-33.4,-0.6) .. controls ++(-7.6,0.2) and ++(7.0,-2.0) .. ++(-23.2,3.2) .. controls ++(-10.6,3.0) and ++(-4.2,-2.4) .. ++(-0.6,7.2) -- cycle ;
				\draw[|-to,shorten <=1.1ex] (x) to ++(0,25.5);
				\draw[|-to,shorten <=1.1ex] (y) to ++(0,25.5);
			\end{scope}
		\end{tikzpicture}
	\end{center}
	Now let's turn this picture upside down! Take $F(x)$ and $F(y)$ and place them above $x$ and $y$. We would like to think of them as the fibres over $x$ and $y$ in some kind of fibration $p\colon \Uu\rightarrow \Cc$:
	\begin{center}
		\begin{tikzpicture}[xscale=\TikzScaleFactor,yscale=-\TikzScaleFactor,line cap=round, line join=round, line width=rule_thickness]
			% F(x)
			\draw [dashed,fill=white!93!black,dash phase=2] (30.3,21.9) .. controls ++(0.6,-0.6) and ++(0.0,1.1) .. ++(1.2,-1.9) .. controls ++(0.0,-1.7) and ++(0.6,1.4) .. ++(-1.2,-3.8) .. controls ++(-1.0,-2.2) and ++(-1.7,0.0) .. ++(3.6,-3.8) .. controls ++(1.7,0.0) and ++(-1.3,-1.7) .. ++(3.6,3.3) .. controls ++(0.8,1.1) and ++(-0.2,-1.6) .. ++(2.4,1.9) .. controls ++(0.2,1.8) and ++(0.8,-1.3) .. ++(-1.2,4.3) .. controls ++(-0.6,0.9) and ++(0.0,-1.2) .. ++(-0.9,2.8) .. controls ++(0.0,1.1) and ++(-0.5,-0.8) .. ++(0.3,2.8) .. controls ++(0.5,0.7) and ++(0.0,-1.0) .. ++(0.6,2.4) .. controls ++(0.0,0.7) and ++(0.1,-0.6) .. ++(-0.6,1.4) .. controls ++(-0.4,1.6) and ++(1.1,0.0) .. ++(-2.4,1.9) .. controls ++(-1.7,0.0) and ++(1.2,1.9) .. ++(-4.3,-1.9) .. controls ++(-0.6,-0.9) and ++(0.8,0.5) .. ++(-1.2,-2.9) .. controls ++(-0.5,-0.3) and ++(0.0,0.8) .. ++(-0.6,-1.9) .. controls ++(0.0,-1.0) and ++(0.0,1.0) .. ++(0.6,-2.4) .. controls ++(0.0,-0.9) and ++(-0.5,0.4) .. ++(0.0,-2.4) -- cycle;
			...
			% U
			\draw (26.5,9.0) .. controls ++(5.0,2.2) and ++(-3.1,-3.1) .. ++(11.6,3.6) .. controls ++(3.8,3.8) and ++(-6.1,0.9) .. ++(16.2,1.4) .. controls ++(8.0,-1.1) and ++(-3.9,0.1) .. ++(14.1,-3.8) .. controls ++(3.9,-0.1) and ++(-2.9,1.0) .. ++(8.2,-1.1) ;
			\draw (28.3,9.6) .. controls ++(4.5,-1.8) and ++(-6.1,0.4) .. ++(18.4,-2.0) .. controls ++(20.0,-1.2) and ++(-2.8,-1.7) .. ++(28.4,1.8) ;
			\draw (7.1,22.7) .. controls ++(5.8,5.2) and ++(-2.7,-5.4) .. ++(21.4,8.1) .. controls ++(3.8,7.7) and ++(-11.3,-1.1) .. ++(26.1,6.2) .. controls ++(13.1,1.3) and ++(-4.9,-1.1) .. ++(18.8,-1.7) .. controls ++(7.9,1.7) and ++(-6.1,4.6) .. ++(17.5,-11.5) .. controls ++(14.6,-11.0) and ++(15.6,3.7) .. ++(-9.0,-21.3) .. controls ++(-18.2,-4.3) and ++(15.5,-0.6) .. ++(-44.7,-0.8) .. controls ++(-10.0,0.4) and ++(9.2,-4.1) .. ++(-29.2,6.2) .. controls ++(-13.9,6.2) and ++(-5.5,-4.9) .. ++(-0.8,14.8) -- cycle ;
			...
			\coordinate (x) at (35,55);
			\coordinate (y) at (69,55);
			\draw [dashed,shorten <=1.35ex] (x) to (29.8,27.5);
			\draw [dashed,shorten <=1.35ex] (x) to (38.8,30.0);
			\draw [dashed,shorten <=1.35ex] (y) to (63.6,27.5);
			\draw [dashed,shorten <=1.35ex] (y) to (74.1,32.3);
			\fill (u) circle (0.45ex/\TikzScaleFactor) node[shift=(120:0.3)] {$u$};
			\fill (v) circle (0.45ex/\TikzScaleFactor) node[shift=(30:0.3)] {$v$};
			\fill (w) circle (0.45ex/\TikzScaleFactor) node[shift=(-30:0.32)] {$w$};
			\fill (x) circle (0.45ex/\TikzScaleFactor) node[below=3] {$x$};
			\fill (y) circle (0.45ex/\TikzScaleFactor) node[below=3] {$y$};
			\begin{scope}[decoration={markings,mark=at position 0.5 with {\arrow{to}}}]
				\draw[postaction={decorate}] ($(u) + (20:1.1ex/\TikzScaleFactor)$)  to[out=20,in=165] node[pos=0.5,above] {$\scriptstyle\varphi$} ($(v) + (165:1.1ex/\TikzScaleFactor)$);
				\draw[postaction={decorate}] ($(u) + (50:1.1ex/\TikzScaleFactor)$)  to[out=50,in=170] node[pos=0.5] (mid) {} ($(w) + (170:1.1ex/\TikzScaleFactor)$);
				\draw[postaction={decorate}] ($(v) + (90:1.1ex/\TikzScaleFactor)$)  to ($(w) + (-90:1.1ex/\TikzScaleFactor)$);
				\draw[postaction={decorate}] ($(x) + (20:1.1ex/\TikzScaleFactor)$)  to[out=20,in=165] node[pos=0.5,below] {$\scriptstyle\alpha$} ($(y) + (165:1.1ex/\TikzScaleFactor)$);
			\end{scope}			
			\path (v) to node[pos=0.67] {$\scriptscriptstyle/\!/\!/$} (mid);
			\node at (24,19) {$F(x)$};
			\node at (81,24) {$F(y)$};
			\node at (8,15) {$\Uu$};
			\node at (20,55) {$\Cc$};
...
\end{defi}
%\begin{numpar}[More informal motivation]
%	Suppose $\varphi\colon u\rightarrow v$ is a $p$-cocartesian morphism in $\Uu$, lying over a morphism $\alpha\colon x\rightarrow y$ in $\Cc$. Let $\sigma\colon \Lambda_0^2\rightarrow \Uu$ be a horn such that $\Delta^{\{0,1\}}\subseteq \Lambda_0^2$ is sent to $\varphi$. Let $\psi\colon u\rightarrow w$ be the image of $\Delta^{\{0,2\}}\subseteq \Lambda_0^2$. As we've explained in \cref{par:StraighteningMotivation}, $\psi$ needs to be the composition of $\varphi$ with some morphism $v\rightarrow w$ in $p^{-1}\{y\}$. If we choose a $2$-simplex $\ov\sigma\colon \Delta^2\rightarrow \Uu$ that witnesses $\psi$ being the composition of $\varphi$ and $v\rightarrow w$, then $\ov\sigma$ is a filler for the horn $\sigma$. This shows that the horn lifting problem from \cref{def:Cocartesian}\cref{enum:CocartesianMorphism} can be solved, at least in this special case for $n=2$. 
%\end{numpar}
...
Still, we'll spend the rest of \cref{subsec:Straightening} to give you some idea how the construction works. We'll start with a few examples that will become very relevant in~\labelcref{exm:Straightening}. After that, we'll explain the effect of straightening on morphisms and discuss two classical examples in~\cref{par:Stacks} and~\cref{par:Coverings}.
...
\subsection{The Yoneda lemma}\label{subsec:Yoneda}
...
\subsection{Remarks on model independence}
...
\begin{lem}\label{lem:HomNaturalTransformation}
	Let $F,G\colon \Cc\rightarrow \Dd$ be functors of quasi-categories and let $\eta\colon F\Rightarrow G$ be a natural transformation. Then the natural transformation from \cref{lem:HomFunctorial} as well as $\eta_*$ \embrace{postcomposition with $\eta$} and $\eta^*$ \embrace{precomposition with $\eta$} fit into a commutative diagram
	\begin{equation*}
		\begin{tikzcd}
...
\end{proof}
\begin{lem}[\enquote{Precomposition commutes with postcomposition}]\label{lem:PrecompositionCommutesWithPostcomposition}
...
\begin{numpar}[Cocartesian and left fibrations, model-independently.]\label{par:ModelIndependence}
